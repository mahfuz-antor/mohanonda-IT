...
import { faCoffee, faLaptopHouse, faBuilding, faLink, faAddressCard } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div style={{backgroundColor: '#171f44'}} className="row  p-5 text-white footer-bg ">
            ...
            <div className="col-md-3 mt-3">
                <p> <FontAwesomeIcon icon={faLaptopHouse} size="2x" className="text-info" /> H#002(3rd floor), Road#44, <br/> Ranibazar, Tiles Porty, Boalia, Rajshahi, Bangladesh</p>
            </div>
            <div className="col-md-3 mt-3">
                <h2 className="text-info"> <FontAwesomeIcon icon={faBuilding} size="1x" /> Our Company</h2>
            ...
            <div className="col-md-3 mt-3">
                <h2 className="text-info"> <FontAwesomeIcon icon={faLink} size="1x" /> Quick Link</h2>
                <a className="text-white" href="#">About Us</a> <br/>
                <a className="text-white" href="#">Contact Us</a> <br/>
                <a className="text-white" href="#">Our Services</a> <br/>
                <a className="text-white" href="#">Our Blogs</a> <br/>
            ...
            <div className="col-md-3 mt-3 p-2">
                <h2 className="text-info"> <FontAwesomeIcon icon={faAddressCard} size="1x" /> About Us</h2>
