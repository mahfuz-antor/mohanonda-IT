            ...
            <div className="">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link me-5" href="#" tabindex="-1" aria-disabled="true">Review</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link me-5" href="#" tabindex="-1" aria-disabled="true">Blogs</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link me-5" href="#" tabindex="-1" aria-disabled="true">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
